...
Rectangle {
    ...
    View3D {
        ...
        environment: SceneEnvironment {
            ...
            lightProbe: Texture {
                source: "qrc:/3DView/textures/skybox.hdr"
            }
        ...
        Node {
            ...
            Node {
                ...
                Behavior on opacity {
                    NumberAnimation {
                        id: galaxyOpacityAnim; duration: 1000
                    }
                }
                ...
                DirectionalLight {
                    color: "#4060ff"; brightness: 0.3; eulerRotation: Qt.vector3d(30, -45, 0)
                }
                DirectionalLight {
                    color: "#ffffff"; brightness: 0.2; eulerRotation: Qt.vector3d(0, 0, 0)
                }
                    ...
                    delegate: Node {
                        ...
                        Node {
                            ...
                            Model {
                                ...
                                NumberAnimation on eulerRotation
                                .
                                y {
                                    from: 0;
        ...
        Node {
            ...
            Node {
                ...
                Model {
                    ...
                    y {
                        from: 0;
                        to: 360; duration: 60000; loops: Animation.Infinite; running: true
                    }
                    NumberAnimation on eulerRotation
                    .
                    z {
                        from: 0;
                        to: 360; duration: 120000; loops: Animation.Infinite; running: true
                    }
                }
                ...
                Model {
                    ...
                    x {
                        from: 0;
                        to: -360; duration: 50000; loops: Animation.Infinite; running: true
                    }
                }
            }
        }
    ...
    ParallelAnimation {
        id: zoomAnimation
        Vector3dAnimation {
            id: zoomAnimationPos; target: mainCamera; property: "position";
            duration: 1500; easing.type: Easing.InOutCubic
        }
        Vector3dAnimation {
            id: zoomAnimationTarget; target: cameraTargetNode; property: "position";
            duration: 1500; easing.type: Easing.InOutCubic
        }
    }
    ...
    ParallelAnimation {
        id: resetAnimation
        Vector3dAnimation {
            target: mainCamera; property: "position";
            to: root.defaultCameraPos; duration: 1500; easing.type: Easing.InOutCubic
        }
        Vector3dAnimation {
            target: cameraTargetNode; property: "position";
            to: root.defaultCameraTarget; duration: 1500; easing.type: Easing.InOutCubic
        }
        Vector3dAnimation {
            target: mainCamera; property: "eulerRotation";
            to: Qt.vector3d(-45, 0, 0); duration: 1500; easing.type: Easing.InOutCubic
        }
    }
            ...
            if (result.objectHit && result.objectHit.pickable) {
                ...
                while (candidate) {
                    if (candidate.objectIndex !== undefined) {
                        root.objectClicked(candidate.objectIndex);
                        break;
                    }
    ...
    Column {
        ...
        Rectangle {
            ...
            Column {
                ...
                Text {
                    text: "Керування"; color: "#e0e0e0"; font.bold: true; font.pixelSize: 14
                }
                Text {
                    text: "ЛКМ + рух: Обертання"; color: "#b0b0b0"; font.pixelSize: 11; wrapMode: Text.WordWrap; width: parent.width
                }
                Text {
                    text: "Коліщатко: Zoom"; color: "#b0b0b0"; font.pixelSize: 11
                }
                Text {
                    text: "ПКМ + рух: Панорама"; color: "#b0b0b0"; font.pixelSize: 11; wrapMode: Text.WordWrap; width: parent.width
                }
                Text {
                    text: "Клік на об'єкті: Вибір"; color: "#b0b0b0"; font.pixelSize: 11; wrapMode: Text.WordWrap; width: parent.width
                }
            }
        }
        Rectangle {
            ...
            Column {
                ...
                Text {
                    text: "Об'єктів у галактиці:"; color: "#b0b0b0"; font.pixelSize: 11; anchors.horizontalCenter: parent.horizontalCenter
                }
                Text {
                    text: celestialModel ? celestialModel.rowCount() : "0"; color: "#4fd1c5"; font.bold: true; font.pixelSize: 20; anchors.horizontalCenter: parent.horizontalCenter
                }
            }
        }
    }
