...
TEST(GraphMatrixTest, AddVertex) {
...
TEST(GraphMatrixTest, RemoveVertex) {
    GraphMatrix<std::string> g;
    g.addVertex(1, "A");
    g.addVertex(2, "B");
    g.addEdge(1, 2);
...
TEST(GraphMatrixTest, FindIndexById) {
    GraphMatrix<std::string> g;
    g.addVertex(1, "A");
    g.addVertex(2, "B");
...
TEST(GraphMatrixTest, VertexSearch) {
    GraphMatrix<std::string> g;
    g.addVertex(1, "A");
    g.addVertex(2, "B");
...
TEST(GraphMatrixTest, EdgeExists) {
    GraphMatrix<std::string> g;
    g.addVertex(1, "A");
    g.addVertex(2, "B");
    g.addVertex(3, "C");
