...
TEST(GalaxyMatrixTest, ConnectObjects) {
    GalaxyType g;
...
TEST(GalaxyMatrixTest, GetGraph) {
    GalaxyType g;
...
TEST(GalaxyMatrixTest, ShowGalaxyOutput) {
    GalaxyType g;
